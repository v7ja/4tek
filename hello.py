...
sessionid = ("58110029876%3ACykaNxAwFY60g2%3A24%3AAYdr898NVpcnnllfTl0TObreugRFxXwUNVt6DCcQaA")
def Lev ():
	...
	while True:
	   user = str("".join(random.choice(litters)for x in range(5)))
